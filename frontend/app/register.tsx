        ...
        >
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.formContainer}>
                    <AuthenticationFormElement placeholder="Nom" />
                    <AuthenticationFormElement placeholder="Prénom" />
                    <AuthenticationFormElement placeholder="Adresse email" />
                    <AuthenticationFormElement placeholder="Mot de passe" />
                    <AuthenticationFormElement placeholder="Confirmer Mot de passe" />
                </View>

                {/* Register Button */}
                <AuthenticationButton name="S'inscrire" />
